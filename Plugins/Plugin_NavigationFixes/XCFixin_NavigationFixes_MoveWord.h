...
{
	[XcodePluginNavigationFixes moveWordForward: self_ arg1: arg1];
}
...
{
	[XcodePluginNavigationFixes moveWordForwardAndModifySelection: self_ arg1: arg1 arg2: _cmd];
}
...
{
	[XcodePluginNavigationFixes moveWordBackward: self_ arg1: arg1];
}
...
{
	[XcodePluginNavigationFixes moveWordBackwardAndModifySelection: self_ arg1: arg1 arg2: _cmd];
}
...
{
	[XcodePluginNavigationFixes deleteWordForward: self_ arg1: arg1];
}
...
{
	[XcodePluginNavigationFixes deleteWordBackward: self_ arg1: arg1];
}
