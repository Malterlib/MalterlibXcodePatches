...
#	echo $Executable 1>&2
	...
	echo -e "\033[32m/opt/Source/class-dump/build/Release/class-dump -H -F --sdk-mac "" -o $CurrentPath/XcodeDump $Executable \033[0m" 1>&2
	/opt/Source/class-dump/build/Release/class-dump -H -F --sdk-mac "" -o $CurrentPath/XcodeDump "$Executable" || true
