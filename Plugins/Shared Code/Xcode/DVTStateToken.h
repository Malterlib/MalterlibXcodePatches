...
@class DVTStackBacktrace, DVTStateRepository, NSArray, NSDictionary, NSString;
...
@interface DVTStateToken : NSObject <DVTInvalidation>
{
    ...
    id <DVTStatefulObject> _statefulObject;
}

+ (void)initialize;
// - (void).cxx_destruct;
@property __weak id <DVTStatefulObject> statefulObject; // @synthesize statefulObject=_statefulObject;
