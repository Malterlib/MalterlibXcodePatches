...
@interface IDEIssueNavigator : IDEOutlineBasedNavigator <DVTOutlineViewDelegate>
{
    ...
    NSMutableSet *_collapsedModelObjectsForStateSaving;
...
@property(copy, nonatomic) NSMutableSet *collapsedModelObjects; // @synthesize collapsedModelObjects=_collapsedModelObjects;
...
- (void)contextMenu_createBreakpoint:(id)arg1;
