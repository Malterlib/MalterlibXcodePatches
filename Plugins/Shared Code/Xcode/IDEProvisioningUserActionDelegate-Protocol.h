...
//
#ifndef IDEProvisioningUserActionDelegate_Protocol_h
#define IDEProvisioningUserActionDelegate_Protocol_h
...
#endif /* IDEProvisioningUserActionDelegate_Protocol_h */
