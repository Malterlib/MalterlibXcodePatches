...
//
#ifndef IDEBoltIndexDatabaseProgressDelegate_Protocol_h
#define IDEBoltIndexDatabaseProgressDelegate_Protocol_h
...
#endif /* IDEBoltIndexDatabaseProgressDelegate_Protocol_h */
