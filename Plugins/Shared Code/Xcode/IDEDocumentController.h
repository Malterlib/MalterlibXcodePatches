...
- (void)_openNextDocumentURLFromIDEApplicationRestorableState:(id)arg1 nextIndex:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)openDocumentURLsFromIDEApplicationRestorableState:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
