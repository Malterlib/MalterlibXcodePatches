...
+ (id)openEditorHistoryItem:(id)arg1 forEditor:(id)arg2 eventBehavior:(int)arg3 takeFocus:(int)arg4;
+ (id)_openRequestForEditorHistoryItem:(id)arg1 editorContext:(id)arg2 eventBehavior:(int)arg3 takeFocus:(int)arg4;
+ (id)openEditorHistoryItem:(id)arg1 forEditor:(id)arg2 takeFocus:(int)arg3;
...
+ (void)_doOpenDocumentURL:(id)arg1 forWorkspaceTabController:(id)arg2 editorContext:(id)arg3 target:(int)arg4 takeFocus:(int)arg5 client:(unsigned long long)arg6 navigationBlock:(CDUnknownBlockType)arg7;
...
+ (int)_allowedTargetForTarget:(int)arg1 maximizedState:(long long)arg2;
