...
@interface Plugin_CustomizeAnnotations : NSObject
{
}
...
- (void)onLoad {
	...
	gOriginalnewMessageAttributesForFont = XcodePluginOverrideMethodString(@"DVTTextAnnotation", @selector(setTheme:forState:), (IMP)&overridenewMessageAttributesForFont);
	XcodePluginAssertOrPerform(gOriginalnewMessageAttributesForFont, goto failed);

	gOriginal_defaultMessageFontSize = XcodePluginOverrideStaticMethodString(@"DVTMessageBubbleView", @selector(_defaultMessageFontSize), (IMP)&override_defaultMessageFontSize);
	XcodePluginAssertOrPerform(gOriginal_defaultMessageFontSize, goto failed);
